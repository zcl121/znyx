#############################################################################
# Makefile for building: znyx1
# Generated by qmake (2.01a) (Qt 4.7.0) on: ?? 9? 10 09:53:27 2019
# Project:  znyx1.pro
# Template: app
# Command: /usr/local/Trolltech/Qt-4.7.0/bin/qmake -o Makefile znyx1.pro
#############################################################################
...
INCPATH       = -I/usr/local/Trolltech/Qt-4.7.0/mkspecs/linux-g++-64 -I. -I/usr/local/Trolltech/Qt-4.7.0/include/QtCore -I/usr/local/Trolltech/Qt-4.7.0/include/QtGui -I/usr/local/Trolltech/Qt-4.7.0/include -I.
LINK          = g++
...
Makefile: znyx1.pro  /usr/local/Trolltech/Qt-4.7.0/mkspecs/linux-g++-64/qmake.conf /usr/local/Trolltech/Qt-4.7.0/mkspecs/common/g++.conf \
		/usr/local/Trolltech/Qt-4.7.0/mkspecs/common/unix.conf \
		/usr/local/Trolltech/Qt-4.7.0/mkspecs/common/linux.conf \
		/usr/local/Trolltech/Qt-4.7.0/mkspecs/qconfig.pri \
		/usr/local/Trolltech/Qt-4.7.0/mkspecs/modules/qt_webkit_version.pri \
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/znyx11.0.0 || $(MKDIR) .tmp/znyx11.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/znyx11.0.0/ && $(COPY_FILE) --parents widget.h .tmp/znyx11.0.0/ && $(COPY_FILE) --parents main.cpp widget.cpp .tmp/znyx11.0.0/ && (cd `dirname .tmp/znyx11.0.0` && $(TAR) znyx11.0.0.tar znyx11.0.0 && $(COMPRESS) znyx11.0.0.tar) && $(MOVE) `dirname .tmp/znyx11.0.0`/znyx11.0.0.tar.gz . && $(DEL_FILE) -r .tmp/znyx11.0.0
